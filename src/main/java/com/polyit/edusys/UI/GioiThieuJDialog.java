...
public class GioiThieuJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/polyit/edusys/Hinh/FPT_Polytechnicsmall.png"))); // NOI18N

        txtIntro.setEditable(false);
        txtIntro.setColumns(20);
        txtIntro.setRows(5);
        txtIntro.setText("Polypro là dự án mẫu. Mục tiêu chính huấn luyện sinh viên qui trình thực hiện dự án.\n\nMục tiêu của dự án này là để rèn luyện kĩ năng IO (CDIO) tức không yêu cầu sinh viên phải thu thập\nphân tích mà chỉ thực hiện và vận hành một phần mềm chuẩn bị cho các dự án sau này. Các kỹ năng CD\ntrong (CDIO) sẽ được huấn luyện ở dự án 1 và dự án 2.\n\nYêu cầu về môi trường:\n1. Hệ điều hành bất kỳ\n2. JDK 1.8 trở lên\n3. SQL Server 2008 trở lên");
